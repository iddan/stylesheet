...
// exports
        ...
        var moduleData = {"Label":{"className":"Label_SyQNMLA-Z","attributes":[{"operator":"=","name":"name","value":"The White Screen","className":"Label-name_HkGm4MURZW_SyQNMLA-Z"}],"attrs":[]}};
...
// exports
        ...
        var importedComponentsData = exports.slice(0, exports.length - 1).map(([id]) => __webpack_require__(id).components);
        var createComponent = __webpack_require__(2);
        var moduleData = {"Label":{"className":"Label_SyQNMLA-Z","attributes":[{"name":"highlighted","className":"Label-highlighted_SygX4MIAWZ_SyQNMLA-Z"},{"operator":"=","name":"name","value":"Ryskin","className":"Label-name_rJ-QEGLCbW_SyQNMLA-Z"}],"attrs":[{"prop":"background","selector":"body .Label_SyQNMLA-Z.Label-highlighted_SygX4MIAWZ_SyQNMLA-Z","template":"linear-gradient(to top, yellow, { color = \"tomato\"})","attributes":["color"]},{"prop":"fontSize","selector":"body .Label_SyQNMLA-Z.Label-highlighted_SygX4MIAWZ_SyQNMLA-Z","template":"calc({ fontSize }px + 12px)","attributes":["fontSize"]}],"base":"span"}};
        var data = deepMerge.apply(null, importedComponentsData.concat(moduleData));
        exports.components = data;
        exports.locals = {
          Label: createComponent(data.Label)
